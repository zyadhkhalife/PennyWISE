...
label = tk.Label(window, text="Currency Converter", font="Times 20 bold" , bg='#6dbd81')
label.place(x=120, y=40)

label1 = tk.Label(window, text="Enter amount here:", font="Times 16 bold" , bg ='#6dbd81') 
label1.place(x=70, y=100)
entry1 = tk.Entry(window)

label2 = tk.Label(window, text="Enter your currency here:", font="Times 16 bold", bg ='#6dbd81')
...
label4 = tk.Label(window, text="", font="Times 16 bold", bg ='#6dbd81')
