...
class EWalletApp:
    ...
    def create_login_screen(self):
        ...
        login_frame = tk.Frame(self.root, bg="#ffffff")  # Changed to white
        login_frame.place(relx=0.75, rely=0.6, anchor="center", relwidth=0.4, relheight=0.7)

        canvas = tk.Canvas(login_frame, bg="#ffffff", highlightthickness=0)  # Changed to white
        canvas.place(relwidth=1, relheight=1)

        self.login_label = tk.Label(canvas, text="LOGIN", font=("Helvetica", 20, "bold"), bg="#ffffff", fg="#000000")  # Changed to white background and black text
        self.login_label.place(relx=0.2, rely=0.1, anchor="center", width=100, height=30)

        self.username_label = tk.Label(canvas, text="Username", font=self.font_style, bg="#ffffff", fg="#000000")  # Changed to white background and black text
        self.username_label.place(relx=0.27, rely=0.22, anchor="center")
        self.username_entry = tk.Entry(canvas, font=self.font_style, bg="#ffffff", fg="#000000", insertbackground="#000000")  # Changed to white background and black text
        self.username_entry.place(relx=0.5, rely=0.27, anchor="center", width=200)

        self.password_label = tk.Label(canvas, text="Password", font=self.font_style, bg="#ffffff", fg="#000000")  # Changed to white background and black text
        self.password_label.place(relx=0.27, rely=0.37, anchor="center")
        self.password_entry = tk.Entry(canvas, show="*", font=self.font_style, bg="#ffffff", fg="#000000", insertbackground="#000000")  # Changed to white background and black text
        self.password_entry.place(relx=0.5, rely=0.42, anchor="center", width=200)

        button_frame = tk.Frame(canvas, bg="#ffffff")  # Changed to white
        button_frame.place(relx=0.5, rely=0.6, anchor="center")

        self.login_button = tk.Button(button_frame, image=self.login_image, command=self.login, borderwidth=0, bg="#ffffff", highlightthickness=0, activebackground="#d0d0d0")  # Changed to white background and light grey active background
        self.login_button.pack(side="left", padx=10)

        self.create_account_button = tk.Button(button_frame, image=self.create_account_image, command=self.create_account_screen, borderwidth=0, bg="#ffffff", highlightthickness=0, activebackground="#d0d0d0")  # Changed to white background and light grey active background
    ...
    def create_account_screen(self):
        ...
        self.register_label = tk.Label(self.root, text="Create Account", font=self.font_style, bg="#ffffff", fg="#000000")  # Changed to white background and black text
        self.register_label.place(relx=0.5, y=100, anchor="center")

        self.new_username_label = tk.Label(self.root, text="Username", font=self.font_style, bg="#ffffff", fg="#000000")  # Changed to white background and black text
        self.new_username_label.place(relx=0.5, y=150, anchor="center")
        self.new_username_entry = tk.Entry(self.root, font=self.font_style, bg="#ffffff", fg="#000000", insertbackground="#000000")  # Changed to white background and black text
        self.new_username_entry.place(relx=0.5, y=180, anchor="center")

        self.new_password_label = tk.Label(self.root, text="Password", font=self.font_style, bg="#ffffff", fg="#000000")  # Changed to white background and black text
        ...
        self.register_button = tk.Button(self.root, image=self.create_account_image, command=self.create_account, borderwidth=0, bg="#ffffff", highlightthickness=0, activebackground="#d0d0d0")  # Changed to white background and light grey active background
        self.register_button.place(relx=0.4, y=270, anchor="center")

        self.back_button = tk.Button(self.root, image=self.back_image, command=self.create_login_screen, borderwidth=0, bg="#ffffff", highlightthickness=0, activebackground="#d0d0d0")  # Changed to white background and light grey active background
    ...
    def change_password_screen(self):
        ...
        self.change_password_label = tk.Label(self.root, text="Change Password", font=self.font_style, bg="#ffffff", fg="#000000")  # Changed to white background and black text
        self.change_password_label.place(relx=0.5, y=100, anchor="center")

        self.old_password_label = tk.Label(self.root, text="Old Password", font=self.font_style, bg="#ffffff", fg="#000000")  # Changed to white background and black text
        self.old_password_label.place(relx=0.5, y=150, anchor="center")
        self.old_password_entry = tk.Entry(self.root, show="*", font=self.font_style, bg="#ffffff", fg="#000000", insertbackground="#000000")  # Changed to white background and black text
        self.old_password_entry.place(relx=0.5, y=180, anchor="center")

        self.new_password_label = tk.Label(self.root, text="New Password", font=self.font_style, bg="#ffffff", fg="#000000")  # Changed to white background and black text
        self.new_password_label.place(relx=0.5, y=210, anchor="center")
        self.new_password_entry = tk.Entry(self.root, show="*", font=self.font_style, bg="#ffffff", fg="#000000", insertbackground="#000000")  # Changed to white background and black text
        self.new_password_entry.place(relx=0.5, y=240, anchor="center")
